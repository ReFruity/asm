...
@start:             call    parseArguments
                    ...
                    mov     error, 1010h
                    jmp     @has_error
@no_error1010:      cmp     arg_b, 2
                    jl      @no_error1031       
                    mov     error, 1031h
                    jmp     @has_error
@no_error1031:      cmp     arg_m, 0ffh
                    jne     @no_error1020
                    mov     error, 1020h
                    jmp     @has_error
...
@pArgSymbolSpaceB:  mov     ax, 31
                    je      @pArgLoopStart

@pArgSymbolN:       cmp     ax, 21
                    je      @pArgSymbolN21
                    cmp     ax, 31
                    je      @pArgSymbolN31
                    cmp     ax, 11
